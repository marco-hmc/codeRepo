...
class Crawler:
    ...
    def save_image(self, rsp_data, word):
        if not os.path.exists("./" + word):
            os.mkdir("./" + word)
        # 判断名字是否重复，获取图片长度
        targetDir = "/home/marco/1_blog/template_blog/vonge-jekyll-bookshop-template/site/images/post"
        self.__counter = len(os.listdir(targetDir)) + 1
        for image_info in rsp_data['data']:
            try:
                ...
                # 保存图片
                dir = '/home/marco/1_blog/template_blog/vonge-jekyll-bookshop-template/site/images/post'
                filepath = f'{dir}/post-{self.__counter}{suffix}'
