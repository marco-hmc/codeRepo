...
* 收获
  * 这个项目是技术预研性质，需要首先跨部门和其他技术专家讨论得到初始的设计方案，基于本部门设备情况改造，得出基本设计方案，再找自己部门的最高技术领导开会讨论。
* 拿到优秀实习生评价（比例约10-15%）
...
* python：
  * 《动手学深度学习-李沐》-看完
    - 基本能够复现所有开源AI算法了
  * 写过爬虫、文件批量处理、正则日常工作脚本都能写，也做过使用python-opencv的一些寻迹小车等等
...
* 浏览器
  * 深入了解现代网络浏览器 - 看完
    * url: https://developer.chrome.com/blog/inside-browser-part1?hl=zh-cn
    
  * 浏览器工作原理与实践 - 选择性看完（跳过了前端部分的内容）
    * url: https://time.geekbang.org/column/intro/100033601?utm_campaign=geektime_search&utm_content=geektime_search&utm_medium=geektime_search&utm_source=geektime_search&utm_term=geektime_search
