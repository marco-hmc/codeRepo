...
// 内存池信息API
mem_size_t MemPool::GetTotalMemory() {}
mem_size_t MemPool::GetAllocMemory() {}
float MemPool::MemoryPoolGetUsage() {}
mem_size_t MemPool::GetProgMemory() {}
float MemPool::MemoryPoolGetProgUsage() {}
