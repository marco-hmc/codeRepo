组合设计模式的本质是将对象组合成树形结构，以表示“部分-整体”的层次结构。通过定义统一的接口，组合模式使得客户端可以透明地处理单个对象和组合对象，从而简化了代码的复杂性和维护成本。
...
int main() {
    ...
    */
    ...
    std::cout << "Client: I don't need to check the components classes even "
