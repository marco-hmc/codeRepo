...
* **左手坐标系**：
    ...
    左手食指：y
    左手中指：z
    在计算机图形学中，左手坐标系较为常用，比如 DirectX 图形库就采用左手坐标系，它在描述物体的空间位置和方向时有着广泛的应用。 
* **右手坐标系**：
    右手大拇指：x
    右手食指：y
    右手中指：z
    此时，大拇指的方向为 x 轴的正方向，食指的方向为 y 轴的正方向，中指的方向为 z 轴的正方向。
    在物理学和数学的很多领域，右手坐标系使用得更为普遍，例如在电磁学中，用右手定则来判断磁场、电流和受力方向之间的关系，就与右手坐标系的方向规定相关。 

左手坐标系和右手坐标系只是坐标轴方向规定的不同，它们都可以用来描述三维空间中的点和向量。在不同的应用场景中，选择合适的坐标系可以使问题的解决更加方便和直观。 
