...
![字节流转换为DOM](_imgs/byte-transform-dom.png)
...
![生成的Token示意图](_imgs/token-sketch.png)
...
![dom树结构](_imgs/dom-tree-construction.png)
