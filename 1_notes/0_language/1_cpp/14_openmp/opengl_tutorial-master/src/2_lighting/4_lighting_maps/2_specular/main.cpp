...
const fs::path shader_path = "src/2_lighting/4_lighting_maps/2_specular";
...
const fs::path box_diffuse_map = "assets/textures/box_diffuse_map.png";
const fs::path box_specular_map = "assets/textures/box_specular_map.png";
